...
void sha256(const void *data, size_t len, char *sha2digest);
...
//Left shift n bit and take latest 8 bits
...
void sha256(const void *data, size_t len, char *sha2digest)
{
	...
	sha256_done(&ctx, h);
	snprintf(sha2digest, 65, "%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x"
	"%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x"
	"%02x%02x%02x%02x", h[0],h[1],h[2],h[3],h[4],h[5],h[6],h[7],h[8],h[9],h[10],h[11],
